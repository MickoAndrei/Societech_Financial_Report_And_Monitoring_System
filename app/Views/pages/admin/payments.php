...
<head>
  ...
  <title>Payment Records • Societech Admin</title>
    ...
    <main class="mainContent">
      <header class="header">
        <div class="headerTitle">
          ...
          <div class="headerBreadcrumb">Track membership and event collections</div>
        </div>
...
<div id="payment-records" class="contentSection active">
                <div class="searchFilterBar">
                    ...
                    <button class="btn btnPrimary">Export Report</button>
                </div>
