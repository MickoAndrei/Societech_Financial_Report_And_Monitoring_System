...
<head>
    ...
    <title>Admin Login - Societech Financial System</title>
...
<body>
    ...
    <div class="loginContainer">
        <div class="loginCard">
            ...
            <form id="adminLoginForm" method="post" action="<?= site_url('admin-login') ?>">
                <?= csrf_field() ?>
                <div class="formGroup">
                ...
                <a href="<?= site_url('login') ?>" class="studentLink">Student login</a>
