...
<head>
  ...
  <title>Contributions • Societech Student</title>
...
<body class="studentLayout" data-page="contributions">
    ...
    <div class="studentContent">
      ...
      <header class="studentTopbar">
        <div class="headerTitle">
          <h1>Contributions</h1>
          <div class="headerBreadcrumb">BSIT class fund and Societech society collections</div>
        </div>
      ...
      <main class="studentMain">
        <div class="studentContentOverlay">
          ...
          <!-- ── Stat Summary Cards ─────────────────────────────
               At-a-glance contribution totals with admin-style icons
          ──────────────────────────────────────────────────────── -->
          <div class="statsGrid" style="margin-bottom:24px;">
            <!-- Class contributions total -->
            <div class="statCard blue">
              <div class="statHeader">
                <div class="statTitle">Class Contributions</div>
                <div class="statIcon">
              ...
              <div class="statTrend">No fetched class contributions</div>
            </div>
            <!-- Organizational contributions total -->
            <div class="statCard purple">
              <div class="statHeader">
                  <div class="statTitle">Societech Assessments</div>
                <div class="statIcon">
                  <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="statValue">₱0</div>
              <div class="statTrend">No fetched Societech assessments</div>
            </div>
            <!-- Already paid total -->
            <div class="statCard green">
              <div class="statHeader">
                <div class="statTitle">Already Paid</div>
                <div class="statIcon">
                  <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="statValue">₱0</div>
              <div class="statTrend">No fetched payments</div>
            </div>
          </div>

          <!-- ── Section: Class Contributions ──────────────────
               Contributions tied to class-level funds and events
          ──────────────────────────────────────────────────────── -->
          <section class="studentSection">
            <h2 class="sectionTitle">Class Contributions</h2>
          ...
          <!-- ── Section: Organizational Contributions ─────────
               Contributions to student orgs and their activities
          ──────────────────────────────────────────────────────── -->
          <section class="studentSection">
            <h2 class="sectionTitle">Organizational Contributions</h2>
            <table class="studentTable">
              <thead>
                <tr>
                  <th>Organization</th>
          ...
          <!-- ── End Organizational Contributions ──────────── -->
