...
(function () {
  ...
  // FIX: wait for async auth/me fetch to complete before running the role guard.
  // DOMContentLoaded fires before student-session.js gets the role back, so
  // requireClassTreasurer() was always false and redirected to /student.
  window.addEventListener('societech-session-ready', initTreasurerRosterPage);
})();