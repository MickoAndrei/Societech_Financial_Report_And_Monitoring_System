/* ============================================================
   student-bar.js — Student sidebar (class + Societech treasurer)
============================================================ */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const isSocTreasurer = window.StudentSession?.isSocietechTreasurer() === true;
  const classLabel = isClassTreasurer ? window.StudentSession.getTreasurerClassLabel() : '';

  let subtitle = 'Societech Student Portal';
  if (isSocTreasurer) subtitle = 'Student · Societech Treasurer';
  else if (isClassTreasurer) subtitle = `Student · Class Treasurer (${classLabel})`;

  const classTreasurerNav = isClassTreasurer
    ? `
      <div class="nav-section" id="class-treasurer-nav">
        <div class="nav-section-title">Class Treasurer</div>
        <a href="class-roster.html" class="nav-item ${currentPath === 'class-roster.html' ? 'active' : ''}">
  ...
  const societechTreasurerNav = isSocTreasurer
    ? `
      <div class="nav-section" id="societech-treasurer-nav">
        <div class="nav-section-title">Societech Treasurer</div>
        <a href="societech-dashboard.html" class="nav-item ${currentPath === 'societech-dashboard.html' ? 'active' : ''}">
          <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
          </svg>
          Treasurer Dashboard
        </a>
        <a href="societech-all-classes.html" class="nav-item ${currentPath === 'societech-all-classes.html' ? 'active' : ''}">
          <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
          </svg>
          All Classes
        </a>
        <a href="societech-payments.html" class="nav-item ${currentPath === 'societech-payments.html' ? 'active' : ''}">
          <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const mainDashboardActive = (currentPath === 'index.html' || currentPath === '') && !isSocTreasurer;
  ...
  const sidebarHTML = [
    ...
    `    <a href="index.html" class="nav-item ${mainDashboardActive ? 'active' : ''}">`,
    ...
    `      ${isSocTreasurer ? 'My Student View' : 'Dashboard'}`,
    '    </a>',
    '  </div>',
    '  <div class="nav-section">',
